...
class ManagerController extends Controller
{
                ...
                if ($iErrorCode == 0) {
                    ...
                    if ($model->save()) {
                        ...
                        if ($number_of_images > $uploadLimit) {
                            ...
                            Image::getImagine()->open($sTempFile)->save(
                                $sMediaPath . $subdirectory . "/" . $sSaveFileName
                            );
                            $bSuccess = true;
                        }
                    }
    ...
    public function actionCrop()
    {
        ...
        if ($modelOriginal->imagePathPrivate !== null && $aCropData !== null) {
            ...
            $sDisplayFileName =
                $sFileName . "_crop_" . $iDimensionWidth . "x" . $iDimensionHeight . "." . $sFileExtension;
            ...
            if ($model->save()) {
                ...
                if ($number_of_images > $uploadLimit) {
                    ...
                    try {
                        ...
                        // create image
                        Image::getImagine()->create(
                            new Box($imageCanvasWidthRounded, $imageCanvasHeightRounded),
                            $imagineColor
                        )
                            ->paste(
                                $imageOriginal,
                            ...
                            ->crop(
                                new Point($imageCropPositionXRounded, $imageCropPositionYRounded),
